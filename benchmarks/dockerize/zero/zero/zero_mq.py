...
class AsyncZeroMQPythonDevice(ZeroMQInterface):
    async def queue_device(
        self,
        host: str,
        port: int,
        worker_ipc: str,
        ...
        try:
            ...
            poller.register(gateway, zmq.POLLIN)
    ...
    async def worker(
        ...
        try:
            ...
            while True:
                ...
                response = await process_message(rpc, msg)
...
AsyncZeroMQ = AsyncZeroMQPythonDevice()
